...
def main() -> int:
    ...
    parser.add_argument("--max-coverage", type=float, default=100.0, help="Maximum halftone coverage; accepts 100 or 1.0")
    ...
    parser.add_argument("--knockout-inner", type=float, default=3.0)
    parser.add_argument("--knockout-outer", type=float, default=30.0)
