...
ALTER TABLE IF EXISTS print_flows ADD COLUMN IF NOT EXISTS notes TEXT;
...
ALTER TABLE IF EXISTS assets ADD COLUMN IF NOT EXISTS downloaded BOOLEAN DEFAULT false;
